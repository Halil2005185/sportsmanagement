        ...
        <div className=" w-[96%] sm:w-[90%] mx-auto ">
            ...
            <div>
                <div className="hidden lg:flex items-center flex-col lg:flex-row justify-between gap-4" >
                    <motion.div variants={container} initial="hidden" animate="show" className="flex flex-col items-center gap-4 w-[90%] lg:w-[50%]" >
                        <motion.div variants={item} className="bg-[#1C1C1C] w-[100%] h-fit lg:h-[172px] flex gap-4 border-[0.5px] border-[#D2FF00] p-6 rounded-[26px] ">
                        ...
                        <motion.div variants={item} className="bg-[#D2FF00] w-full h-fit lg:h-[172px] flex gap-4  p-6 rounded-[26px] ">
                        ...
                        <motion.div variants={item} className="bg-[#1C1C1C] w-full h-fit lg:h-[172px] flex gap-4 border-[0.5px] border-[#D2FF00] p-6 rounded-[26px] ">
                            <PiStarFourFill className=" text-[#D2FF00] drop-shadow-[0px_6px_23px_#D2FF0080] text-[100px] pb-[50px] " />
                            <p className="text-[24px] leading-[100%] font-['Chakra_Petch'] text-white ">OA Sports is a multidisciplinary sports consulting and management company that unites diverse expertise under one roof and views sports as a complete ecosystem.</p>
                        </motion.div>
                    </motion.div>
            ...
            <div>
                ...
                <motion.div variants={container} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.4 }} className="flex lg:flex-row flex-col lg:items-center gap-8 my-10 ">
                    <motion.div variants={item} className="lg:w-[33%] border-[1px] border-[#D2FF00] bg-[#1C1C1C] h-[222px] lg:self-end rounded-[24px] flex justify-center items-center flex-col">
                    ...
                    <motion.div variants={item} className="lg:w-[33%] border-[1px] border-[#D2FF00] bg-[#1C1C1C] h-[222px] lg:h-[254px] rounded-[24px] flex  items-center flex-col justify-evenly">
                        <AiFillGitlab className="text-[#D2FF00] text-[60px]" />
                        <p className="text-[20px] font-['Chakra_Petch'] leading-[100%] text-white text-center w-[90%] ">We manage the planning behind the scenes with professionalism and strengthen your performance.</p>                    </motion.div>
                    <motion.div variants={item} className="lg:w-[33%] border-[1px] border-[#D2FF00] bg-[#1C1C1C] h-[222px] lg:self-end rounded-[24px] flex justify-center items-center flex-col">
                        <AiFillGitlab className="text-[#D2FF00] text-[60px]" />
                        <p className="text-[20px] font-['Chakra_Petch'] leading-[100%] text-white text-center">We are not just a consulting company; we are your strategic partner in your sports journey.</p>                    </motion.div>
                </motion.div>
            </div>
