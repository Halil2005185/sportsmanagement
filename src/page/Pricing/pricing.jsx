...
function Pricing() {
    ...
    return <section className="bg-[#121212]">
        <div className="w-full sm:w-[90%] mx-auto flex flex-col gap-4 ">
            <h2 className="italic font-bold leading-[100%] py-8 font-['Platypi'] text-white text-[32px] px-3 lg:px-0 lg:text-[48px]"><span className="text-[#D2FF00]" >{t("pricingPage.hero.title.highlight")}</span> {t("pricingPage.hero.title.after")}</h2>
