    ...
    return (
        <section className=" relative w-screen bg-[#121212]">
            ...
            >
                <motion.h4
                    variants={item}
                    className="text-white font-['Platypi'] font-bold italic text-[26px] lg:text-[32px] leading-[100%] w-full mx-auto"
                >
                    What
                    <span className="text-[#D2FF00] px-2 leading-[100%]">OA Sports</span>
                    do
                ...
                <motion.div
                    ...
                    <motion.div variants={item} className="sm:w-[48%] lg:w-[45%] xl:w-[32%]" >
                        <WhySports
            ...
            >
                <motion.div variants={item} className="w-[98%] mx-auto md:w-[331px] min-h-[303px] py-2">
                    <LatestNews />
                </motion.div>
                <motion.div variants={item} className="w-[98%] mx-auto md:w-[331px] min-h-[303px] py-2">
                    <LatestNews />
                        ...
                        <div className="flex flex-col gap-8 justify-evenly h-full ">
                            ...
                            <div className="flex flex-col gap-8 ">
                                <p className="text-white md:text-[24px] font-['Chakra_Petch'] leading-[100%]">
                                    OA Sports is a multifaceted sports consulting and management
                                    company that brings together multidisciplinary expertise under
                                    one roof, OA Sports is a multifaceted sports consulting and
                                    management company that brings together multidisciplinary
