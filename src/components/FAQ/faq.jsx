                ...
                <div className="flex flex-col justify-center gap-4"  >
                    <div className="flex items-center gap-4" >
                        <div className="w-[55%] xl:h-[150px] bg-[#1C1C1C] border-[#D2FF00] border-[1px] rounded-[24px] py-[24px] px-[20px] ">
                            <p className=" xl:text-[20px] leading-[100%] font-['Chakra_Petch'] text-white " >{t("faqContent.box1")}</p>
                        </div>
                        <div className="w-[45%] xl:h-[150px] bg-[#1C1C1C] border-[#D2FF00] border-[1px] rounded-[24px] py-[24px] px-[14px] ">
                            <p className=" xl:text-[20px] leading-[100%] font-['Chakra_Petch'] text-white " >{t("faqContent.box2")}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3" >
                        <div className="bg-[#1C1C1C] border-[#535862] border-[1px] py-6 px-2 rounded-[24px] flex gap-2" >
                            ...
                            <p className=" text-white xl:text-[24px] font-['Chakra_Petch'] leading-[100%] " >{t("faqContent.card1")}</p>
                        </div>
                        <div className="bg-[#1C1C1C] border-[#535862] border-[1px] py-6 px-2 rounded-[24px] flex gap-2">
                            <BsStars className="text-[#D2FF00] drop-shadow-[0_6px_23px_#D2FF00] lg:text-[50px]" />
                            <p className=" text-white xl:text-[24px] font-['Chakra_Petch'] leading-[100%]"> {t("faqContent.card2")}</p>
                        </div>
                        <div className="bg-[#1C1C1C] border-[#535862] border-[1px] py-6 px-2 rounded-[24px] flex gap-2" >
                            <BsStars className="text-[#D2FF00] drop-shadow-[0_6px_23px_#D2FF00] lg:text-[50px]" />
                            <p className=" text-white xl:text-[24px] font-['Chakra_Petch'] leading-[100%] " >{t("faqContent.card3")}</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex flex-col lg:hidden items-center gap-4 w-full" >
                <div className="flex flex-col gap-4 lg:py-20" >
                    <div className="bg-[#D2FF00] border-[#D2FF00] border-[2px] rounded-[16px] p-4">
                        <p className=" text-[20px] leading-[100%] font-['Chakra_Petch']  " >{t("faqContent.box1")}</p>
                    </div>
                    <img src={statistics} alt="statistics" className=" rounded-[16px] sm:h-[400px] mx-auto object-contain" />
                    <div className="bg-[#D2FF00] border-[#D2FF00] border-[2px] rounded-[16px] p-4" >
                        <p>{t("faqContent.box2")}</p>
                    </div>
                </div>
                <div className="overflow-x-auto flex w-full items-center gap-4">
                    <div className="w-[310px] h-[253px] bg-[#1C1C1C] border-[#535862] border-[2px] flex gap-1 items-start  rounded-[36px] py-[24px] px-[16px] ">
                        ...
                        <p className="text-[#FFFFFF] text-[24px] font-['Chakra_Petch'] " >{t("faqContent.card1")}</p>
                    </div>
                    <div className="w-[310px] h-[253px] bg-[#1C1C1C] border-[#535862] border-[2px] flex gap-1 items-start  rounded-[36px] py-[24px] px-[16px] ">
                        <BsStars className="text-[#D2FF00] drop-shadow-[0_6px_23px_#D2FF00] text-[100px] self-start " />
                        <p className="text-[#FFFFFF] text-[24px] font-['Chakra_Petch'] " >{t("faqContent.card2")}</p>
                    </div>
                    <div className="w-[310px] h-[253px] bg-[#1C1C1C] border-[#535862] border-[2px] flex gap-1 items-start  rounded-[36px] py-[24px] px-[16px] ">
                        <BsStars className="text-[#D2FF00] drop-shadow-[0_6px_23px_#D2FF00] text-[100px] self-start " />
                        <p className="text-[#FFFFFF] text-[24px] font-['Chakra_Petch'] " >{t("faqContent.card3")}</p>
                    </div>
                    <div className="w-[310px] h-[253px] bg-[#1C1C1C] border-[#535862] border-[2px] flex gap-1 items-start  rounded-[36px] py-[24px] px-[16px] ">
                        <BsStars className="text-[#D2FF00] drop-shadow-[0_6px_23px_#D2FF00] text-[100px] self-start " />
                        <p className="text-[#FFFFFF] text-[24px] font-['Chakra_Petch'] " >{t("faqContent.card4")}</p>
                    </div>
                </div>
            </div>
        </div>
